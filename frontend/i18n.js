const TRANSLATIONS = {
    ...
    en: {
        ...
        'loading': 'Cargando...',
        'errorLoadingEvents': 'Error al cargar información de los eventos',
        ...
        'votes': 'votos',
        'agreeLabel': 'confirman',
        'yourVerification': 'Tu verificación',
        'verificationQuestion': '¿Es válida esta contradicción?',
        'voteAgree': 'Sí, confirmo',
        'voteDisagree': 'No, falsa alarma',
        'voteUncertain': 'No estoy seguro',
        'yourConfidence': 'Tu confianza',
        'commentOptional': 'Comentario (opcional)',
        'commentPlaceholder': 'Explica tu razonamiento...',
        'yourName': 'Tu nombre',
        'namePlaceholder': 'Nombre o apodo',
        'submitVerification': 'Enviar verificación',
        'submitting': 'Enviando...',
        'successVerification': '¡Gracias! Tu verificación se registró correctamente.',
        'errorNoName': 'Por favor ingresa tu nombre',
        'errorNoVote': 'Por favor selecciona una opción',
    ...
    en: {
        ...
        'sources.feedRegion': 'Region (US / global...)',
        'sources.addTopic': 'Add topic...',
        'sources.topicsHint': 'Only news mentioning these topics will be downloaded. No topics = all.',
        'sources.enabled': 'enabled',
        'sources.noTopics': 'No topic filter (all downloaded)',
        ...
        'detail.confirm.delete': 'Are you sure you want to delete this node?',
        ...
        'verificationQuestion': 'Is this contradiction valid?',
        'voteAgree': 'Yes, confirm',
        'voteDisagree': 'No, false alarm',
        'voteUncertain': 'Not sure',
        'yourConfidence': 'Your confidence',
        'commentOptional': 'Comment (optional)',
        'commentPlaceholder': 'Explain your reasoning...',
        'yourName': 'Your name',
        'namePlaceholder': 'Name or nickname',
        'submitVerification': 'Submit verification',
        'submitting': 'Submitting...',
        'successVerification': 'Thank you! Your verification was recorded.',
        'errorNoName': 'Please enter your name',
        'errorNoVote': 'Please select an option',
